...
// CreateNewRelayerSRV ...
func CreateNewRelayerSRV(logger *logrus.Logger, gormDB *gorm.DB, laConfig, posCfg *models.WorkerConfig, bscCfg, ethCfg *models.WorkerConfig) *RelayerSRV {
	// init database
...
func (r *RelayerSRV) GetSwapStatus(req *models.SwapStatus) (storage.SwapStatus, error) {
	...
	// }
	swap, err := r.storage.GetSwapByStatus(req.Sender, req.Receipt, req.Amount)
	if err != nil {
